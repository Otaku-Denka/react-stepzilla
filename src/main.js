...
export default class StepZilla extends Component {
        ...
        this.props.steps.map((i, idx) => {
            if (this.props.dontValidate) {
                ...
                i.validated =
                    ...
                    (typeof i.component.type.prototype.isValidated ===
                        'undefined' &&
    ...
    getPrevNextBtnState(currentStep) {
        ...
        if (currentStep >= this.props.steps.length - 1) {
            showNextBtn = false;
            showPreviousBtn =
                this.props.prevBtnOnLastStep === false ? false : true;
        }
    ...
    stepMoveAllowed(skipValidationExecution = false) {
        ...
        if (this.props.dontValidate) {
            ...
            if (skipValidationExecution) {
                ...
                this.isStepAtIndexHOCValidationBased(this.state.compState)
            ) {
    ...
    render() {
        ...
        const componentPointer = this.props.steps[this.state.compState]
            .component;
